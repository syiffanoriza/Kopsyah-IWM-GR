        ...
        <div class="container w-full">
            ...
            <div class="w-full flex">
                <div class="grid overflow-x-auto px-2 py-4 grid-cols-2 lg:grid-cols-4 gap-3">
                    <div
                        class="w-full hover:bg-primary-900/10 max-w-sm bg-white border border-gray-900 rounded-lg transition duration-500 ease-in-out hover:shadow-lg hover:shadow-primary-100 pt-3 px-2.5">
                        ...
                        <div class="px-1 pb-3 md:pb-4">
                            ...
                            <div class="flex items-end justify-between">
                                <div class="flex items-center space-x-0.5">
                                    <span class="font-normal text-gray-600 text-sm md:text-xs rounded">Rp</span>
                                    <p class="text-primary-900 text-sm md:text-xl font-medium">25.000</p>
                                </div>
