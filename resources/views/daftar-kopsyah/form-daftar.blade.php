        ...
        <div class="flex flex-wrap my-20">
            <div class="w-full space-y-5 items-center">
                ...
                <p class="text-lg lg:w-2/3 mx-auto text-center font-normal text-gray-500 md:text-xl px-8 sm:px-16 xl:px-48">
                    Dengan ini saya mengajukan <span class="text-primary-900">Permohonan Menjadi Anggota Koperasi Syariah IWM GR</span> dan <a href="daftar"><span
                        class="hover:text-primary-900 hover:underline">bersedia memenuhi
            ...
            <form class="max-w-3xl mx-auto">
                <div class="mb-5">
                    ...
                    <input type="text" id="large-input"
                        class="block w-full p-4 text-gray-900 border border-gray-500 rounded-lg bg-gray-50 text-base focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-600 dark:focus:border-primary-600"
                        placeholder="Tulis nama lengkap anda" required>
                </div>
                <div class="mb-5">
                    <label for="large-input"
                        class="block mb-2 text-md font-bold text-primary-900 dark:text-white">Alamat Domisili</label>
                    <input type="text" id="large-input"
                        class="block w-full p-4 text-gray-900 border border-gray-500 rounded-lg bg-gray-50 text-base focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-600 dark:focus:border-primary-600"
                ...
                <div class="mb-5">
                    <label class="block mb-2 text-md font-bold text-primary-900 dark:text-white"
                        for="large_size">Akad</label>
                ...
                <div class="mb-5">
                    <label class="block mb-2 text-md font-bold text-primary-900 dark:text-white"
                        for="large_size">Informasi Penggunaan Rekening</label>
                    <div class="border border-gray-500 rounded-lg p-4 text-md font-medium">
                ...
                <a href="#">
                    <button type="submit"
                        class="text-white bg-gradient-to-r from-[#7AD800] to-[#00A500] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-primary-300 shadow-lg shadow-primary-900/30 font-medium rounded-lg text-lg px-10 py-3 text-center my-16 me-2 mb-4 tracking-wide w-full">Submit</button>
                </a>
            </form>
