                    ...
                    <div id="crud-modal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form class="pb-4">
                                    <div
                                        class="h-80 overflow-y-auto border rounded-lg m-5 md:p-5 border-primary-900 p-4 grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="nama"
                                                class="block mb-2 text-sm font-medium text-primary-900">Nama
                                                Lengkap</label>
