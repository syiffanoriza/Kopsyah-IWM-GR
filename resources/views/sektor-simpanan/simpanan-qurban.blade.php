        ...
        <div class="flex flex-wrap mb-16">
            <div class="w-full p-10 space-y-2 lg:space-y-5 items-center">
                ...
                <p
                    ...
                    Kopsyah IWM GR memberikan fasilitas produk simpanan Qurban dalam bentuk<span
                        class="text-primary-800"> Akad Wadiah </span>yang merupakan
                    ...
                    <div class="flex flex-col items-start">
                        ...
                        <ul class="my-3 max-w-md space-y-1 text-gray-500 list-inside">
                            <li class="flex items-center">
                                <svg class="w-3.5 h-3.5 me-2 text-primary-900 flex-shrink-0" aria-hidden="true"
                            ...
                            <li class="flex items-center">
                                <svg class="w-3.5 h-3.5 me-2 text-primary-900 dark:text-primary-400 flex-shrink-0"
                            ...
                            <li class="flex items-center">
                                <svg class="w-3.5 h-3.5 me-2 text-primary-900 dark:text-gray-400 flex-shrink-0"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path
                                        d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form class="pb-4">
                                        <div
                                            ...
                                            {{-- Jenis Hewan Qurban --}}
                                            <div class="col-span-2">
                                                <label for="jenis-hewan"
                                                    class="block mb-2 text-sm font-medium text-primary-900">Jenis
                                                    Hewan Qurban
                                                </label>
                                                <select id="jenis-hewan" name="jenis-hewan"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-900 focus:border-primary-900 block w-full p-2.5">
                                            ...
                                            <div id="tipe-container" class="col-span-2 hidden">
                                                <label for="tipe-hewan"
                                                    class="block mb-2 text-sm font-medium text-primary-900">Tipe
                                                    Hewan Qurban
                                                </label>
                                                <select id="tipe-hewan" name="tipe-hewan"
                                                    class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-900 focus:border-primary-900">
                                            ...
                                            <div id="angsuran-container" class="col-span-2 hidden">
                                                <label for="angsuran"
                                                    class="block mb-2 text-sm font-medium text-primary-900">Masa
                                                    Angsuran</label>
