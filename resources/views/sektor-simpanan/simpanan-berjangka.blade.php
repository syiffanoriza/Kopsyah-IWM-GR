        ...
        <div class="flex flex-wrap mb-16">
            <div class="w-full p-10 space-y-2 lg:space-y-5 items-center">
                ...
                <p
                    ...
                    menggunakan sistem
                    <span class="text-primary-800">Revenue Sharing </span>bagi hasil setara<span
                        class="text-primary-800"> 6-8% pertahun.</span>
                </p>
                ...
                <div class="p-7 max-w-2/3 bg-white border border-gray-700 rounded-lg shadow-lg shadow-primary-300/40">
                    <div class="flex flex-col items-start">
                        <div class="flex items-center gap-4">
                            ...
                            <h5 class="mb-2 text-3xl font-medium tracking-tight text-gray-900">Manfaat & <span
                                    class="text-primary-900">Keuntungan</span>
                            </h5>
                        </div>
                                        ...
                                        <div
                                            ...
                                            <div class="col-span-2">
                                                <label for="member-number"
                                                    ...
                                                    Anggota</label>
                                                <input type="text" id="member-number" name="member-number"
                                            ...
                                            <div class="col-span-2">
                                                <label for="number"
                                                    class="block mb-2 text-sm font-medium text-primary-900">Nomor
                                                    Telepon</label>
                                                <input type="number" name="number" id="number" min="00000000"
                                                    max="00000000"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-900 focus:border-primary-900 block w-full p-2.5 "
                                            ...
                                            <div class="col-span-2">
                                                <label for="jangka-waktu"
                                                    class="block mb-2 text-sm font-medium text-primary-900">Jangka
                                                    Waktu Penyimpanan
                                                </label>
                                                <select id="category"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                    <option selected="" class="text-gray-500">Pilih Jangka Waktu
                                                    </option>
                                            ...
                                            <div class="col-span-2">
                                                <label for="penempatan-awal"
                                                    class="block mb-2 text-sm font-medium text-primary-900">Penempatan
                                                    Awal
                                                </label>
                                                <input type="number" name="number" id="number" min="1000000"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-900 focus:border-primary-900 block w-full p-2.5 "
                                                    placeholder="Penempatan minimum 1 Juta" required="">
                                            </div>
                                            <div class="col-span-2">
                                                <label class="block mb-2 text-sm font-medium text-primary-900"
                                                    for="user_avatar">Upload Bukti TF</label>
                                                <input
                                                    class="block w-full text-sm text-gray-500 border border-gray-300 accent-primary-900 rounded-lg cursor-pointer bg-gray-50 focus:outline-none"
                                                    aria-describedby="user_avatar_help" id="user_avatar"
                                                    type="file">
                                            </div>
                                        </div>
                                        <button type="submit" id="submit-button"
                                            class="text-white bg-gradient-to-r from-[#7AD800] to-[#00A500] hover:bg-gradient-to-br mx-auto flex items-center px-[110px] rounded-lg py-2 justify-center shadow shadow-primary-900/30 font-medium">
