...
<script>
    ...
    function sendMessage() {
        ...
        const url = `https://api.whatsapp.com/send?phone=62811884747&text=*PENDAFTARAN%20SIMPANAN%20UMROH*%0A%0ANo.%20Anggota%3A%20*${nomorAnggota}*%0ANama%3A%20*${nama}*%0ATelepon%3A%20*${telepon}*%0A%0ATerima%20kasih%2C%20saya%20menunggu%20konfirmasi%20dari%20pihak%20Kopsyah.`;
        ...
        <div class="flex flex-wrap mb-16">
            <div class="w-full p-10 space-y-2 lg:space-y-5 items-center">
                ...
                <p class="text-base lg:w-4/5 mx-auto text-center font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48">
                    ...
                    dengan atau
                    tanpa izin pemiliknya, dapat memanfaatkan barang yang disimpan dan harus <span class="text-primary-800"> bertanggung jawab atas kehilangan atau kerusakan</span> barang
                    tersebut.
                </p>
...
<<<<<<< HEAD
                                    <form class="pb-4" onsubmit="sendMessage()">
                                        <div class=" h-64 overflow-y-auto border rounded-lg m-5 border-primary-900 px-4 pt-2 grid grid-cols-2">
=======
                                    <form class="pb-4">
                                        <div
                                            class=" h-64 overflow-y-auto border rounded-lg m-5 border-primary-900 px-4 pt-2 gap-2 grid grid-cols-2">
>>>>>>> e33faca4f45d868db66968a15ac5e5785a33488c
                                            <div class="col-span-2">
                                                <label for="nomor-anggota" class="block mb-1 text-sm font-medium text-primary-900">Nomor
                                                    Anggota</label>
<<<<<<< HEAD
...
>>>>>>> e33faca4f45d868db66968a15ac5e5785a33488c
                                            ...
                                            <div class="col-span-2">
                                                <label for="nama" class="block mb-1 text-sm font-medium text-primary-900">Nama
                                                    Lengkap</label>
                                            ...
                                            <div class="col-span-2">
                                                <label for="nomor-telepon" class="block mb-1 text-sm font-medium text-primary-900">Nomor
                                                    Telepon</label>
