        ...
        <div class="container">
            <div class="flex flex-wrap px-4 items-center justify-center gap-10">
                <div
                    ...
                    <h5 class="mb-2 text-2xl font-medium tracking-tight text-primary-900">Cepat <span
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea id="description" rows="4"
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-900 focus:border-primary-900 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-900 dark:focus:border-primary-900"
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input datepicker datepicker-autohide type="date"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-900 focus:border-primary-900 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-900 dark:focus:border-primary-900"
                                            placeholder="Select date">
                                    </div>
                                </div>
                                <button type="submit"
                                    class="justify-center text-white bg-gradient-to-r from-[#7AD800] to-[#00A500] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-primary-300 shadow shadow-primary-900/30 font-medium rounded-lg inline-flex items-center bg-primary-900 hover:bg-primary-800 text-sm px-5 py-2.5 text-center">
