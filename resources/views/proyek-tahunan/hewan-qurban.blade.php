...
<body>
        ...
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
                ...
                <div class="max-w-lg">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 sm:text-4xl">Hewan Qurban</h2>
                    <hr class="h-0.5 w-32 bg-gray-700 my-4">
                    <p class="mt-4 text-gray-500 text-md font-medium">Projek Qurban merupakan projek tahunan yang diselenggarakan oleh Kopsyah IWM GR dalam memenuhi kebutuhan hewan Qurban bagi Anggota ataupun masyarakat sekitar yang ingin berQurban dengan harga terjangkau.</span></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="flex flex-wrap my-10 gap-y-6">
            <div class="w-full px-10 space-y-5 items-center">
                <h3 class="text-gray-400 text-center tracking-widest font-medium my-2 text-lg">Menyediakan</h3>
                <h2 class="text-center text-4xl md:2/5 lg:w-3/4 xl:w-2/4 font-bold tracking-wide mx-auto md:text-4xl lg:text-4xl sm:text-4xl">
                    Hewan <span class="text-primary-800">Qurban</span>
                </h2>
            ...
            <div class="flex mx-auto lg:mx-auto">
                <div class="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 p-4 md:p-2 xl:p-5 justify-center items-center">
                    <!-- <div class="relative p-10 space-y-2 text-center rounded-md border">
                    ...
                    <div class="w-full h-auto max-w-full bg-white border border-gray-700 rounded-lg shadow-md">
                        <div class="flex flex-col items-center px-4 py-5 lg:px-2 lg:py-7">
                            <img class="w-80 mb-3 border border-gray-700 rounded-lg shadow-sm" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-5.jpg" alt="" />
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Sapi</h5>
                        </div>
                    </div>
                    <div class="w-full h-auto max-w-full bg-white border border-gray-700 rounded-lg shadow-md">
                        <div class="flex flex-col items-center px-4 py-5 lg:px-2 lg:py-7">
                            <img class="w-80 mb-3 border border-gray-700 rounded-lg shadow-sm" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-5.jpg" alt="" />
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Kambing Jawa</h5>
                        </div>
                    </div>
                    <div class="w-full h-auto max-w-full bg-white border border-gray-700 rounded-lg shadow-md">
                        <div class="flex flex-col items-center px-4 py-5 lg:px-2 lg:py-7">
                            <img class="w-80 mb-3 border border-gray-700 rounded-lg shadow-sm" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-5.jpg" alt="" />
                            <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Domba</h5>
                        </div>
                    </div>
                </div>
            </div>
