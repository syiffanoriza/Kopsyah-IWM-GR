    ...
    <section class="my-10">
        ...
        <div class="h-full flex w-full justify-center items-center dark:bg-gray-800 py-5 px-5">
            <div class="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-4 md:p-2 xl:p-5">
                <div
                    class="relative bg-white border border-gray-300 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 transform transition duration-500 hover:scale-105">
                    ...
                    <div class="px-4 pb-3">
                        <div>
                            ...
                            <p class="antialiased text-gray-600 dark:text-gray-400 text-sm break-all">
                                Lorem ipsum dolar sit amet con setur adivisa, queensland null appointed, kukudos on your
                                own design.
                            </p>
                        </div>
                    </div>
            ...
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
                    ...
                    <a href="#"
                        ...
                        <span class="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">Nama
                            Kegiatan</span>
                    </a>
                    <!-- image - end -->
            ...
            <div class="bg-gradient-to-br from-primary-500 to-primary-900 p-10 lg:p-20 rounded-[45px]">
                <div class="max-w-6xl px-4 mx-auto md:max-w-4xl sm:max-w-2xl sm:px-6">
                    <div class="text-center">
                        ...
                        <h2
                            class="max-w-md lg:px-10 sm:px-5 md:px-5 mx-auto mt-3 font-normal text-gray-100 text-md sm:mt-5 sm:text-md md:mt-5 md:text-xl sm:max-w-xl md:max-w-xl">
