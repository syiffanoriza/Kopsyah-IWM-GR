    ...
    <div class="shadow-md bg-transparent rounded-xl hover:bg-primary-100">
        ...
        <div id="accordion-color-body" class="hidden" aria-labelledby="accordion-color-heading">
            <div class="p-5 pt-0 border border-t-0 border-gray-900 rounded-b-xl">
                <p class="mb-2 text-gray-800">Flowbite is an open-source library of interactive components built on top
                    of Tailwind CSS including buttons, dropdowns, modals, navbars, and more.</p>
                <p class="text-gray-800">Check out this guide to learn how to <a
                        href="/docs/getting-started/introduction/" class="text-primary-600 hover:underline">get
                        started</a> and start developing websites even faster
